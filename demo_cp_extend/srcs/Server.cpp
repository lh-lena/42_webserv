...
void	Server::generateResponse()
{
	//1) check if requested file exist
		// create error response in case of an error
	//2) create response depending on the file type and method from request header
		// generate response for HTML-file
		// run CGI-script to get HTML-file
		// save new data to assigned location
		// delete file
}
